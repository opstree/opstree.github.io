...
def _generate_user_contribution_report(users_info):
    for users in users_info:
        ...
        output_data = _generate_filtered_data(repo_data,category)
        
        _generate_git_contribution_report("user",github_username,output_data)
...
def _generate_orgs_contribution_report(orgs_info):
    for orgs in orgs_info:
        ...
        _generate_git_contribution_report("orgs",github_orgs,output_data)
